...
Inherits Application
	...
	#tag MenuHandler
		Function EngineEngineManager() As Boolean Handles EngineEngineManager.Action
			wndEnginesManager.show
		End Function
	#tag EndMenuHandler
	...
	#tag MenuHandler
		Function HelpDefectTrackingSystem() As Boolean Handles HelpDefectTrackingSystem.Action
			ShowURL "http://www.redsauce.net/mantis/login.php?username=reporter&password=reporter"
		End Function
	#tag EndMenuHandler
	...
	#tag MenuHandler
		Function NewProject() As Boolean Handles NewProject.Action
			//If a location has been chosen, we create the new project
			dim newTimeline as new wndTimeLine
			
			// And load the project
			newTimeline.NewProject

...
Begin Menu mnuMain
   ...
   Begin MenuItem ProjectMenu
      ...
      Begin MenuItem mnuEditDatabase
         ...
         AutoEnable = True
      End
      Begin MenuItem ProjectGenerate
         SpecialMenu = 2
         Text = ""
         Index = -2147483648
         AutoEnable = True
   ...
   Begin MenuItem ElementsMenu
      ...
      Begin MenuItem ElementsSubdivide
         ...
         Text = "Subdivide..."
         Index = -2147483648
         Help = "This command splits the current element in several identical items. All the properties are stretched to fit the new size.This means that, for example, splitting a five-seconds color fade into five items you will get five color faders of one second duration each one."
         AutoEnable = True
      End
   ...
   Begin MenuItem Help
      ...
      Begin MenuItem HelpSpntzHomePage
         ...
         AutoEnable = True
      End
      Begin MenuItem HelpDefectTrackingSystem
         SpecialMenu = 0
